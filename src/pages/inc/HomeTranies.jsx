                ...
                <div className="pbminfotech-box-content">
                  <div className="pbmit-team-title-wapper d-flex">
                    <h3 className="pbmit-team-title">
                      <a href={`/about/traine/${el.id}`}>Mr. {el.name}</a>
                    </h3>
                  ...
                  <a className="pbmit-team-btn" href={`/about/traine/${el.id}`}>
            ...
            {/* <article className="pbmit-team-style-2">
              <div className="pbminfotech-post-item">
                <div className="pbminfotech-box-content">
                  <div className="pbmit-team-title-wapper d-flex">
                    <h3 className="pbmit-team-title">
                      <a href={`/about/traine/${el.id}`}>Mr. Raj Patwa</a>
                    </h3>
            ...
            <article className="pbmit-team-style-2">
              <div className="pbminfotech-post-item">
                <div className="pbminfotech-box-content">
                  <div className="pbmit-team-title-wapper d-flex">
                    <h3 className="pbmit-team-title">
                      <a href={`/about/traine/${el.id}`}>Mr. Rohan Prajapati</a>
                    </h3>
